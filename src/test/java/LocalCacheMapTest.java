...
public class LocalCacheMapTest extends BaseTest{
    ...
    public void setupClient(){
        ...
        RedissonClient redissonNonReactiveClient = config.getClient();

        LocalCachedMapOptions<Integer, Student> mapOptions = LocalCachedMapOptions.<Integer, Student> defaults()
                .syncStrategy(LocalCachedMapOptions.SyncStrategy.UPDATE)
                .reconnectionStrategy(LocalCachedMapOptions.ReconnectionStrategy.NONE);
        RLocalCachedMap<Integer, Student> map = redissonNonReactiveClient.getLocalCachedMap("students",
               new TypedJsonJacksonCodec(Integer.class, Student.class), mapOptions);
    }
